...
const demoTranslations: Record<DemoLanguage, Record<string, string>> = {
  es: {
    ...
    "form.demoLimits": "Demo: 10 fotos · 3 vídeos · 6 audios",
    ...
    "form.step1.descriptionPlaceholder": "Por ejemplo: Bienvenidos a nuestra boda.",
    "form.step1.background": "Fotografía de fondo",
    ...
    "form.step1.durationHelp": "Es el tiempo en el que se podrán hacer fotos. Antes del inicio y después del fin, el evento estará cerrado.",
    ...
    "form.step1.revealHelp": "En este momento se revelan todas las fotos del evento y se muestran en la galería accesible por el mismo QR o el enlace de acceso.",
    ...
    "form.step2.acceptLegalPrefix": "He leído y acepto los",
    "form.step2.acceptLegalMiddle": "y la",
    "form.step2.terms": "Términos y Condiciones",
    "form.step2.privacy": "Política de Privacidad",
    "form.step2.acceptMarketing": "Autorizo el envío de comunicaciones comerciales por email (opcional).",
    ...
    "form.errors.legalRequired": "Debes aceptar los Términos y la Política de Privacidad para continuar.",
    "form.errors.imageUpload": "No se pudo subir la imagen",
    "form.errors.eventCreate": "No se pudo crear el evento",
    "form.errors.invalidDates": "Revisa las fechas: inicio, fin y revelado deben ser posteriores a ahora y en orden correcto.",
    ...
    "summary.demoLabel": "Evento de prueba • {photos} fotos · {videos} vídeos · {audios} audios",
    ...
    "summary.qrTryNow": "¡Escanea este QR ahora con tu móvil y mira cómo ha quedado tu evento!",
    "summary.qrMobilePrefix": "Haz",
    "summary.qrMobileLink": "click aquí",
    "summary.qrMobileSuffix": "para ver tu evento.",
    "summary.revealCountdown": "En {hours} horas y {minutes} minutos podrás ver las fotos, vídeos y audios revelados desde el mismo código.",
    "summary.revealCountdownMinutes": "En {minutes} minutos podrás ver las fotos, vídeos y audios revelados desde el mismo código.",
    "summary.revealedNow": "¡El contenido ya está revelado! Escanea el mismo código para verlo.",
  ...
  en: {
    ...
    "form.demoLimits": "Demo: 10 photos · 3 videos · 6 audios",
    ...
    "form.step1.descriptionPlaceholder": "For example: Welcome to our wedding.",
    "form.step1.background": "Background photo",
    ...
    "form.step1.durationHelp": "This is the time window when guests can take photos. Before the start and after the end, the event is closed.",
    ...
    "form.step1.revealHelp": "At this date and time all photos will be revealed in the gallery, accessible via the same QR or the access link.",
    ...
    "form.step2.acceptLegalPrefix": "I have read and accept the",
    "form.step2.acceptLegalMiddle": "and the",
    "form.step2.terms": "Terms and Conditions",
    "form.step2.privacy": "Privacy Policy",
    "form.step2.acceptMarketing": "I authorize email communications (optional).",
    ...
    "form.errors.legalRequired": "You must accept Terms and Privacy Policy to continue.",
    "form.errors.imageUpload": "Could not upload the image",
    "form.errors.eventCreate": "Could not create the event",
    "form.errors.invalidDates": "Check your dates: start, end and reveal must be after now and in the correct order.",
    ...
    "summary.demoLabel": "Demo event • {photos} photos · {videos} videos · {audios} audios",
    "summary.qrAlt": "Event QR",
    "summary.qrDownload": "Download QR",
    "summary.qrHint": "Guests can scan this QR code to access the event",
    "summary.qrTryNow": "Scan this QR code now with your phone and see how your event looks!",
    "summary.qrMobilePrefix": "Click",
    "summary.qrMobileLink": "here",
    "summary.qrMobileSuffix": "to view your event.",
    "summary.revealCountdown": "In {hours} hours and {minutes} minutes you will be able to see the revealed photos, videos and audio from the same code.",
    "summary.revealCountdownMinutes": "In {minutes} minutes you will be able to see the revealed photos, videos and audio from the same code.",
    "summary.revealedNow": "The content has now been revealed! Scan the same code to see it.",
  ...
  it: {
    ...
    "form.demoLimits": "Demo: 10 foto · 3 video · 6 audio",
    ...
    "form.step1.descriptionPlaceholder": "Per esempio: Benvenuti al nostro matrimonio.",
    "form.step1.background": "Foto di sfondo",
    ...
    "form.step1.durationHelp": "È il periodo in cui gli invitati possono scattare foto. Prima dell’inizio e dopo la fine l’evento è chiuso.",
    ...
    "form.step1.revealHelp": "In questo momento tutte le foto verranno rivelate nella galleria accessibile dallo stesso QR o dal link di accesso.",
    ...
    "form.step2.acceptLegalPrefix": "Ho letto e accetto i",
    "form.step2.acceptLegalMiddle": "e la",
    "form.step2.terms": "Termini e Condizioni",
    "form.step2.privacy": "Informativa sulla Privacy",
    "form.step2.acceptMarketing": "Autorizzo l'invio di comunicazioni commerciali via email (opzionale).",
    ...
    "form.errors.legalRequired": "Devi accettare Termini e Privacy per continuare.",
    "form.errors.imageUpload": "Impossibile caricare l’immagine",
    "form.errors.eventCreate": "Impossibile creare l’evento",
    "form.errors.invalidDates": "Controlla le date: inizio, fine e rivelazione devono essere dopo adesso e nell’ordine corretto.",
    ...
    "summary.demoLabel": "Evento demo • {photos} foto · {videos} video · {audios} audio",
    ...
    "summary.qrTryNow": "Scansiona ora questo QR con il telefono e guarda com’è venuto il tuo evento!",
    "summary.qrMobilePrefix": "Fai",
    "summary.qrMobileLink": "clic qui",
    "summary.qrMobileSuffix": "per vedere il tuo evento.",
    "summary.revealCountdown": "Tra {hours} ore e {minutes} minuti potrai vedere foto, video e audio rivelati dallo stesso codice.",
    "summary.revealCountdownMinutes": "Tra {minutes} minuti potrai vedere foto, video e audio rivelati dallo stesso codice.",
    "summary.revealedNow": "I contenuti sono stati rivelati! Scansiona lo stesso codice per vederli.",
