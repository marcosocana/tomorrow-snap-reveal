...
const translations: Record<Language, TranslationStrings> = {
  es: {
    ...
    camera: {
      ...
      seePhotos: "Ver",
      countdownReveal: "Quedan {hours} horas y {minutes} minutos para que se revelen las fotos. ¡Qué nervios!",
      countdownStart: "Quedan {hours} horas y {minutes} minutos para que comience el evento",
      countdownUpload: "Puedes subir todas las fotos que quieras hasta {date} a las {time} horas. ¡Solo quedan {hours} horas y {minutes} minutos!",
  ...
  en: {
    ...
    camera: {
      ...
      seePhotos: "View",
      countdownReveal: "{hours} hours and {minutes} minutes left until photos are revealed. How exciting!",
      countdownStart: "{hours} hours and {minutes} minutes left until the event starts",
      countdownUpload: "You can upload as many photos as you want until {date} at {time}. Only {hours} hours and {minutes} minutes left!",
  ...
  it: {
    ...
    camera: {
      ...
      seePhotos: "Vedi",
      countdownReveal: "Mancano {hours} ore e {minutes} minuti alla rivelazione delle foto. Che emozione!",
      countdownStart: "Mancano {hours} ore e {minutes} minuti all'inizio dell'evento",
      countdownUpload: "Puoi caricare tutte le foto che vuoi fino a {date} alle {time}. Mancano solo {hours} ore e {minutes} minuti!",
