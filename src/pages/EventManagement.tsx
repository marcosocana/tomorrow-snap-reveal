...
const EventManagement = () => {
  ...
  const loadDatabaseUsage = useCallback(async () => {
    ...
    try {
      const { data, error } = await (supabase.rpc as unknown as (fn: string) => Promise<{ data: Array<{ database_bytes: number; database_pretty: string }> | null; error: unknown }>)("get_admin_database_usage");
