...
export default function CaptainModel({ sprite, config, photoUrl, className = "" }: CaptainModelProps) {
  ...
  return <span className={`captain-model ${visual.dressLike ? "is-dress" : "is-suit"} ${className}`} style={getCaptainSpriteCss(sprite, config)} aria-hidden="true">
    <svg className="captain-model-art" viewBox="0 0 180 240" fill="none">
      ...
      <g strokeLinejoin="round" strokeLinecap="round">
        ...
        <path d="M62 207c7 3 15 3 23 0l2 11c0 6-9 8-23 8-9 0-12-4-9-9Z" fill={fill("shoe")} />
        <path d="M96 207c7 3 15 3 22 0l9 11c3 7-7 9-20 8-9 0-14-3-13-8Z" fill={fill("shoe")} />
        ...
        <path d="M60 108c-9-2-17 4-20 14l-9 33c-1 6 13 10 17 3l15-28Z" fill={fill("cloth")} />
        <path d="M121 109c9-2 16 5 19 14l8 32c2 7-13 11-17 4l-14-29Z" fill={fill("cloth")} />
        <path d="m43 121-8 31m100-29 8 28" stroke="#fff" strokeOpacity=".17" strokeWidth="2.5" />
        <path d="m32 153 16 5-2 7-16-5Zm99 6 16-5 2 7-16 5Z" fill={fill("shirt")} />
        ...
        {visual.dressLike ? <>
          <path d="M68 103 77 99c5 13 23 14 29 0l11 5c10 8 8 21 1 34l-1 8 19 45c-19 13-69 14-91 0l19-45-1-9c-7-17-7-27 5-33Z" fill={fill("cloth")} />
          <path d="M76 103c7 13 25 13 31 0" stroke={fill("gold")} strokeWidth="2" />
          <path d="M66 137c15 5 33 5 50 0l1 8c-17 5-35 5-53 0Z" fill={fill("lapel")} />
          <rect x="85" y="138" width="12" height="8" rx="2" stroke={fill("gold")} strokeWidth="2" />
          <path d="m71 151-11 37m22-34-3 39m19-39 4 38m8-41 13 37" stroke="#fff" strokeOpacity=".14" strokeWidth="3" />
          <path d="M50 190c24 10 57 10 80-1" stroke="#000" strokeOpacity=".15" strokeWidth="2" />
        </> : <>
          ...
          <path d="m70 103-7 17 9 4-5 7 23 27-12-55Zm41 0 8 17-10 5 6 7-25 26 15-54Z" fill={fill("lapel")} stroke="#fff" strokeOpacity=".14" strokeWidth=".8" />
