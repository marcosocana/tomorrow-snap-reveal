-- 20260719190000_harden_captains_public_game (adjusted: keep existing captains_event_status signature to avoid dependency cascade)
...
DROP POLICY IF EXISTS "Public can update active captains tables" ON public.captains_tables;
...
DROP POLICY IF EXISTS "Public can insert active captains progress" ON public.captains_table_challenges;
...
DROP POLICY IF EXISTS "Public can update active captains progress" ON public.captains_table_challenges;
...
DROP POLICY IF EXISTS "Public can register active captains access" ON public.captains_table_accesses;
...
DROP POLICY IF EXISTS "Public can insert active captains evidence" ON public.captains_evidence;
...
DROP POLICY IF EXISTS "Public can upload active captain evidence files" ON storage.objects;
